...
public class CustomerDetails {
	...
	public CustomerDetails(Long custId, String custName, Long accountNo, String accName, String custAddr1,
	...
	*/
	...
	public String toString() {
		return "CustomerDetails [custId=" + custId + ", custName=" + custName + ", accountNo="
				+ accountNo + ", accName=" + accName + ", custAddr1=" + custAddr1 + ", mobileNo=" + mobileNo
				+ ", custAddr2=" + custAddr2 + ", emailId=" + emailId + ", custAddr3=" + custAddr3 + ", panNumber="
				+ panNumber + ", txAmount=" + txAmount + ", currency=" + currency + ", purposeCode=" + purposeCode
